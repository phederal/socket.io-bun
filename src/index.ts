...
class Server<
	 ...
	 * });
	 */
	ListenEvents extends EventsMap = DefaultEventsMap | Empty,
	/**
	 ...
	 * io.emit("hello", "world");
	 */
	EmitEvents extends EventsMap = ListenEvents | Empty,
	/**
	 ...
	 * });
	 */
	ServerSideEvents extends EventsMap = DefaultEventsMap | Empty,
	/**
...
export type { Empty, DefaultSocketData };
